...
result = np.load('../data/twopopubidirrevise1-1.npy')
result2 = np.load('../data/twopopubidirrevise1-2.npy')
...
for popu in range(2):
    for i in range(2):
        ...
        if i==0:
            ...
            ax.set_xticklabels([w_ee_list_weak[0], w_ee_list_weak[div_n-1]]) 
...
plt.savefig('../figure/twopopuclearbidirrevise1.pdf')
